...
def main():
    ...
    args = {
        "batch_size": 1,
        "patience": 50,
        "alias_experiment": f"test_" + str(0),
        "weight_decay": 0.01,
        "hidden_size": 1,
        "num_layers": 1,
        "dropout": 0.3,
    ...
    for split in range(5):
        ...
        print(final_acc9_test)
    print("acc9_test", mean(final_acc9_test))
    print("acc9_test_st", stdev(final_acc9_test))
    print("acc9_val", mean(final_acc9_val))
    print("mse_val", mean(final_mse_val))
    print("mse_test", mean(final_mse_test))
    print("mse_test_st", stdev(final_mse_test))
